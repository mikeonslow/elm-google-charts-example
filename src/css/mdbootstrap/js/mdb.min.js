              ...
              (i.each = function(t, e, n, a) {
                ...
                (i.getValueAtIndexOrDefault = function(t, e, n) {
                  return void 0 === t || null === t
                    ? n
                    : i.isArray(t) ? (e < t.length ? t[e] : n) : t;
                }),
              ...
              (i.requestAnimFrame =
                ...
                (i.getRelativePosition = function(t, e) {
                  ...
                  return {
                    ...
                    y: (a = Math.round(
                      (a - s.top - d) / p * o.height / e.currentDevicePixelRatio
                    ))
                  };
                }),
                  ...
                  update: function(i) {
                    ...
                    if (A.length) {
                      ...
                      C.filter &&
                        ...
                        "center" === g
                          ? "left" === p ? (u += m) : "right" === p && (u -= m)
                          : "left" === p ? (u -= v) : "right" === p && (u += v),
                        (D = { x: u, y: d });
                    } else P.opacity = 0;
                    return (
                      (P.xAlign = T.xAlign),
                      ...
                      this.isHorizontal()
                        ? ((a = e.log10(this.end) - e.log10(r)),
                          0 === o
                            ...
                            : ((i = this.width),
                              (n =
                                this.left + i / a * (e.log10(o) - e.log10(r)))))
                        : ((i = this.height),
                          0 !== r || s.reverse
                  ...
                  getValueForPixel: function(t) {
                    ...
                    return (
                      this.isHorizontal()
                        ? ((n = this.width),
                          (i =
                            this.start * Math.pow(10, (t - this.left) * a / n)))
                        : ((n = this.height),
                          (i =
